...
<head>
        <meta charset="utf-8" />
        <title>Category List | Exam Portal</title>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    @foreach($categorylist as $key => $categorylistval)
                                                        <tr>
                                                            ...
                                                            <td>{{$categorylistval->category_name}}</td>
                                                            <td>{{$categorylistval->description}}</td>
                                                            <td class="table-action">
                                                                <a href="{{route('editCategory',$categorylistval->id)}}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="{{route('destroyCategory',$categorylistval->id)}}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach  
                                                    </tbody>
