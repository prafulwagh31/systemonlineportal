...
<head>
        <meta charset="utf-8" />
        <title>Categories | Exam Portal</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Edit Catgeory</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Edit Catgeory</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane show active" id="form-row-preview">
                                                    <form  method="POST" action="{{ route('updateCategory',$editcategory?->getKey()) }}"  enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                        <div class="mb-3">
                                                            <label for="inputPassword4" class="form-label">Name</label>
                                                            <input type="text" class="form-control" id="inputEmail4" name="category_name" value="{{ $editcategory?->category_name}}" placeholder="Category Name">
                                                            <span style="color:red;">{{ $errors->first('category_name') }}</span>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="inputPassword4" class="form-label">Description</label>
                                                            <textarea class="form-control" name="description" style="height: 150px;">{{ $editcategory?->description}}</textarea>
