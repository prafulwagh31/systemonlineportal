                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane show active" id="form-row-preview">
                                                    <form method="POST" action="{{ route('updatefaq',$editfaq?->getKey()) }}"  enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="description" name="description" style="height: 150px;">{{ $editfaq?->description}}</textarea>
