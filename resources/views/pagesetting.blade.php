                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h2 class="header-title">Page Setting</h2>

                                            <div class="tab-content">
                                                <div class="tab-pane show active" id="form-row-preview">
                                                    <form>
                                                        <div class="mb-3">
                                                                <label for="inputEmail4" class="form-label">About Us<span style="color:red;"> * </span></label>
                                                                <textarea class="form-control" id="aboutus" rows="4" name="aboutus"></textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                                <label for="inputEmail4" class="form-label">Terms & Condition<span style="color:red;"> * </span></label>
                                                                <textarea class="form-control" id="termscondition" rows="4" name="termscondition"></textarea>
                                                        </div>
