                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                    @foreach($aboutlist as $key => $aboutlistval)
                                                        <tr>
                                                            <td>{{$aboutlist->firstItem()+$key}}</td>
                                                            <td>{{$aboutlistval->language}}</td>
                                                            <td>{{$aboutlistval->description}}</td>
                                                            <td class="table-action">
                                                                <a href="{{route('editaboutsus',$aboutlistval->id)}}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="{{route('destroyaboutus',$aboutlistval->id)}}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
