                    ...
                    <div class="col-xxl-4 col-lg-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="mobile" id="mobile" name="mobile"  placeholder="Enter your Mobile no">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Already have account? <a href="{{ route('logindata') }}" class="text-muted ms-1"><b>Log In</b></a></p>
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
