...
<head>
        <meta charset="utf-8" />
        <title>Aboutus List | Exam Portal</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h2 class="header-title">Aboutus List</h2>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                    @foreach($termconditionlist as $key => $termconditionlistval)
                                                        <tr>
                                                            <td>{{$termconditionlist->firstItem()+$key}}</td>
                                                            <td>{{$termconditionlistval->language}}</td>
                                                            <td>{{$termconditionlistval->description}}</td>
                                                            <td class="table-action">
                                                                <a href="{{route('edittermscondition',$termconditionlistval->id)}}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="{{route('destroytermscondition',$termconditionlistval->id)}}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
