        ...
        @endif
          <div class="card-body">
            ...
            {{ csrf_field() }}
              ...
              <div class="form-label-group">
                <input type="mobile" id="inputMobile" class="form-control" name="mobile" placeholder="Enter Mobile">
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" style="width: 387px;">Register</button>
              <br><br>
